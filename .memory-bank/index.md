...
**Последнее обновление**: 2026-02-02 (после протокола 0017 - Budget UI Improvements)
...
- ✅ Интеграция бюджета целей с календарём (завершена, PR #16-17, протокол 0016-0017)
  ...
  - 59 новых unit тестов (всего 402)
