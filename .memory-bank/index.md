...
**Статус**: Батч 4 (Budget-Calendar Integration) завершен ✅, Epic-04-Advanced Features в процессе (5/6 фичи)

**Последнее обновление**: 2026-02-02 (после протокола 0016 - Budget-Calendar Integration)
...
- ✅ Интеграция бюджета целей с календарём (завершена, PR #16, протокол 0016)
  - BudgetReservationService с двумя режимами резервирования
  - "fixed_date" — recurring операция "Резерв на цели" на указанную дату
  ...
  - 53 новых unit тестов (всего 396)
