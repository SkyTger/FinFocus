...
**Статус**: 🔄 Epic-09 начат (Фаза 1: Auto-bootstrap в работе)
**Прогресс Epic-09**: 0/4 фаз завершено (0%)
...
### Фазы:
- [ ] Фаза 1: Auto-bootstrap (БЛОКЕР) 🔴 — автосоздание User + seed категорий + миграции
- [ ] Фаза 2: User Profile — welcome screen, имя + аватарка, sidebar profile
