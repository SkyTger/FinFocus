...
def create_sidebar():
    ...
    header = html.Div([
        html.Div([
            html.I(className="bi bi-currency-dollar text-success me-2", style={"fontSize": "1.5rem"}),
    ...
    user_info = html.Div([
        html.Div([
            html.Div([
                html.I(className="bi bi-person-circle", style={"fontSize": "2rem"}),
            ], className="me-3"),
            html.Div([
    ...
    for item in nav_items:
        link = dbc.NavLink([
            html.I(className=f"bi {item['icon']} me-3"),
            item["label"]
        ],
        href=item["href"],
