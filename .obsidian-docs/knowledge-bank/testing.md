---
name: testing
description: Стратегия тестирования FinFocus — 639 тестов, стратегия относительных дат против календарного протухания, CI на pytest
type: reference
---
...
**639 тестов, все проходят** (протокол 0028, на ревью — `639 passed`;
до него 565 базовых, проверено 2026-08-21, Python 3.10.12).
Тестов в `tests/`: 37 файлов (`test_*.py`, без подкаталогов).
...
**Последнее обновление**: 2026-08-25 (протокол 0028, на ревью — счётчик
565 → 639 тестов, добавлена практика mutation-проверки формул).
Предыдущее обновление: 2026-08-19 (аудит KB: заменено устаревшее
"0% coverage" на факт; задокументирована стратегия относительных дат
