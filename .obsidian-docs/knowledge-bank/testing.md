...
**766 тестов, все проходят** (протокол 0030, на ревью — `766 passed`
= 693 на main + 72 по протоколу 0030 (карточки-двери щитка) + 1 на
ревью, фикс двухуровневой двери Wishlist (3.5-m-fix). До 0030 было
...
**Последнее обновление**: 2026-08-26 (протокол 0030, на ревью — счётчик
