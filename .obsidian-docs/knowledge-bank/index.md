...
(протокол 0029 на ревью — 639 смерженных протоколом 0028 + 54 новых).

**Epic-11 «щиток», кусок 1 из 3 — СМЕРЖЕН, долги куска 1 закрыты**
(протокол 0028, PR #28, смержено; протокол 0029 на ревью, мерж
...
**Последнее обновление**: 2026-08-25 (протокол 0029 на ревью — долги
...
- [protocols.md] - История протоколов разработки (0002-0029) с деталями реализации; 0028 смержен (Epic-11 кусок 1), 0029 на ревью (долги куска 1); включая packaging-врезку и открытый вопрос №1 (способ доставки)
...
- [x] ✅ Долги куска 1 (протокол 0029, на ревью, мерж предстоит):
