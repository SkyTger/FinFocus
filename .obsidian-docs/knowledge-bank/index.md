...
не принято. Выпущен релиз `v0.9.0-beta.1`. 898 unit-тестов на ветке
протокола 0032 (было 825 после протокола 0031 и закрытия тестового
долга куска 3 — см. «Epic-11» ниже; +53 протоколом 0032).
...
(защитная заплатка — служебные операции в списке операций) реализован
протоколом 0032**; шаг 3 (концепт-обсуждение «разделы после щитка») —
следующий.
