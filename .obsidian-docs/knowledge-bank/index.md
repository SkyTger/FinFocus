...
(протокол 0030 на ревью 2026-08-26 — 693 протоколом 0029 + 73 новых).

**Epic-11 «щиток», кусок 1 и его долги — СМЕРЖЕНЫ, кусок 2 (карточки-двери) —
НА РЕВЬЮ** (протокол 0028 PR #28 и протокол 0029 PR #29 смержены;
протокол 0030 PR #30 на ревью, мерж переведёт `/protocol-cleanup`):
...
**Последнее обновление**: 2026-08-26 (протокол 0030 на ревью — кусок 2
Epic-11 реализован: карточки-двери, DashboardPanelService, сайдбар без
...
- [protocols.md] - История протоколов разработки (0002-0029) с деталями реализации; 0028 смержен (Epic-11 кусок 1), 0029 смержен (долги куска 1); включая packaging-врезку и открытый вопрос №1 (способ доставки)
...
**Epic-11 «щиток» — редизайн дашборда, кусок 1 и долги смержены, кусок 2 на ревью**:
...
- [x] 🔎 Кусок 2 (протокол 0030, PR #30, на ревью): пять карточек-дверей
...
**Последнее обновление**: 2026-08-26 (протокол 0030 на ревью: кусок 2
Epic-11 реализован — карточки-двери, DashboardPanelService, сайдбар
