---
name: features
description: Обзор реализованных функций FinFocus — кассовый календарь, CRUD операций, накопительные цели, dashboard-щиток, аналитика, wishlist, с указанием протоколов и файлов
type: reference
