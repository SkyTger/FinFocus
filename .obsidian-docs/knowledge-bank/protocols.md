---
name: protocols
description: История протоколов разработки FinFocus (0002-0028) — контекст, решения, реализация каждого; включая незапротоколированную packaging-работу; 0028 на ревью
type: reference
originSessionId: -
---
...
**Статус**: 🔶 НА РЕВЬЮ (PR #28, ветка `0028-money-layers-panel`) — мерж предстоит
...
- Дашборд — самый слабый раздел по UX-аудиту 2026-08-20: не отвечает ни
  ...
  данных, куски 2 (карточки-двери) и 3 (полоска-меню) впереди
