---
name: protocols
description: История протоколов разработки FinFocus (0002-0029) — контекст, решения, реализация каждого; включая незапротоколированную packaging-работу; 0029 смержен
type: reference
originSessionId: -
---
