---
name: protocols
description: История протоколов разработки FinFocus (0002-0029) — контекст, решения, реализация каждого; включая незапротоколированную packaging-работу; 0029 на ревью
type: reference
originSessionId: -
---
...
**Статус**: 🔍 НА РЕВЬЮ (ветка `0029-panel-debts`, мерж предстоит)
