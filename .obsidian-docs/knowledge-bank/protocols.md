---
name: protocols
description: История протоколов разработки FinFocus (0002-0030) — контекст, решения, реализация каждого; включая незапротоколированную packaging-работу; 0030 на ревью
type: reference
originSessionId: -
---
...
**Статус**: 🔎 НА РЕВЬЮ (PR #30; в «смержено» переведёт `/protocol-cleanup`
после мержа)
