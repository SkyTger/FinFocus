---
name: architecture
description: Архитектура FinFocus — слои Dash-приложения, сервисы, ORM, редизайн дашборда «щиток» (кусок 1 смержен, куски 2-3 не начаты)
type: reference
originSessionId: -
---
...
(протокол 0028, PR #28, смержено 2026-08-25, a6e566a):
