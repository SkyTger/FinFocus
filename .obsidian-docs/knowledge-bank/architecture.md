---
name: architecture
description: Архитектура FinFocus — слои Dash-приложения, сервисы, ORM, редизайн дашборда «щиток» (кусок 1 и долги смержены, кусок 2 на ревью, кусок 3 не начат)
type: reference
originSessionId: -
---
...
**Редизайн дашборда «щиток» (Epic-11)** — 3 куска, кусок 1 и его долги
СМЕРЖЕНЫ (протокол 0028 PR #28, протокол 0029 PR #29), кусок 2
РЕАЛИЗОВАН, НА РЕВЬЮ (протокол 0030, PR #30):
...
**~~Кусок 2~~ Карточки-двери**: ✅ РЕАЛИЗОВАНО, НА РЕВЬЮ (протокол 0030)
